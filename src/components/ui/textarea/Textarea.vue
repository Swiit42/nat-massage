<template>
  <textarea
    :value="modelValue"
    :class="cn(
      'flex min-h-[100px] w-full rounded-xl border border-stone-200 bg-white px-4 py-3 text-sm text-stone-900 shadow-sm ring-offset-white transition-colors placeholder:text-stone-400 resize-none',
